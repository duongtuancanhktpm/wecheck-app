...
abstract class ChartCanvas {
  ...
  void drawIconText(TextElement textElement,IconData icon, bool isShowLineStart,bool isShowLineEnd, double lengthLineStart,double lengthLineEnd, Color colorLength, int offsetX, int offsetY,
      {double rotation = 0.0});
