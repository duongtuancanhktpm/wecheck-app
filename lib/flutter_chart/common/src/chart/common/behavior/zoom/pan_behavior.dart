...
import '../../../cartesian/axis/axis_custom.dart' show AxisCustom;
...
class PanBehavior<D> implements ChartBehavior<D> {
  ...
  void onPanStart() {
    ...
    _chart!.getMeasureAxis(axisId: AxisCustom.secondaryMeasureAxisId).lockAxis = true;
  }
  ...
  void onPanEnd() {
    ...
    _chart.getMeasureAxis(axisId: AxisCustom.secondaryMeasureAxisId).lockAxis = false;
    _chart.redraw();
