...
abstract class CartesianChart<D> extends BaseChart<D> {
  ...
  AxisCustom<D>? get domainAxis => _domainAxis;
  ...
  @protected
  AxisCustom<D>? createDomainAxisFromSpec(AxisSpec<D> axisSpec) {
  ...
  NumericAxis getMeasureAxis({String? axisId}) {
    NumericAxis? axis;
    if (axisId == AxisCustom.secondaryMeasureAxisId) {
      axis = _secondaryMeasureAxis;
    } else if (axisId == AxisCustom.primaryMeasureAxisId) {
  ...
  Map<String, List<MutableSeries<D>>> preprocessSeries(
    ...
    for (final series in seriesList) {
      ...
      _usePrimaryMeasureAxis = _usePrimaryMeasureAxis ||
          (measureAxisId == null || measureAxisId == AxisCustom.primaryMeasureAxisId);
      _useSecondaryMeasureAxis = _useSecondaryMeasureAxis ||
          (measureAxisId == AxisCustom.secondaryMeasureAxisId);
    }
