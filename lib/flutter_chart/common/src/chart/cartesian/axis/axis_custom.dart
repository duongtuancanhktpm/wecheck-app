...
const measureAxisKey = AttributeKey<AxisCustom<Object>>('Axis.measureAxis');
const domainAxisKey = AttributeKey<AxisCustom<Object>>('Axis.domainAxis');
...
abstract class AxisCustom<D> extends ImmutableAxis<D> implements LayoutView {
  ...
  AxisCustom({this.tickProvider, TickFormatter<D>? tickFormatter, this.scale})
      : _defaultScale = scale,
...
class NumericAxis extends AxisCustom<num> {
...
class OrdinalAxis extends AxisCustom<String> {
  OrdinalAxis({
