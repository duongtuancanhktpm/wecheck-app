...
import '../axis_custom.dart' show AxisCustom;
...
class AxisSpec<D> {
  ...
  void configure(
      AxisCustom<D> axis, ChartContext context, GraphicsFactory graphicsFactory) {
  ...
  /// Creates an appropriately typed [AxisCustom].
  AxisCustom<D>? createAxis() => null;
