...
import 'package:wecheck/flutter_chart/charts/src/text_style.dart' as style;
import 'package:flutter/material.dart';
import 'package:meta/meta.dart' show protected;

import '../../../charts/src/text_element.dart';
...
class CustomCircleSymbolRenderer extends CircleSymbolRenderer {
  ...
  CustomCircleSymbolRenderer(this.valueShow);
  ...
  void paint(ChartCanvas canvas, Rectangle<num> bounds,
    ...
    var intValue = int.parse(valueShow);
    var colorBackground = intValue > 180 ? Color.red : Color.blue;
    var widthInfo = intValue > 100 ? bounds.width + 25 : bounds.width+15;

    canvas.drawRect(
        Rectangle(bounds.left - 5, bounds.top - 30, widthInfo,
            bounds.height + 8),
    ...
    canvas.drawText(TextElement(valueShow, style: textStyle),
