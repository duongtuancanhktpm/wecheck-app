...
/// range.
@immutable
class RangeAnnotationCustom<D> extends ChartBehavior<D> {
  final desiredGestures = new Set<GestureType>();

  /// List of annotations to render on the chart.
  final List<common.AnnotationSegmentCustom<Object>> annotations;

  /// Configures where to anchor annotation label text.
  final common.AnnotationLabelAnchorCustom? defaultLabelAnchor;

  /// Direction of label text on the annotations.
  final common.AnnotationLabelDirectionCustom? defaultLabelDirection;

  /// Configures where to place labels relative to the annotation.
  final common.AnnotationLabelPositionCustom? defaultLabelPosition;
  ...
  @override
  common.RangeAnnotationCustom<D> createCommonBehavior() =>
      common.RangeAnnotationCustom<D>(annotations,
  ...
  bool operator ==(Object o) {
    return o is RangeAnnotationCustom &&
