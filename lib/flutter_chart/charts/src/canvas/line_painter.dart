...
import 'package:wecheck/flutter_chart/common/common.dart' as common show Color;
import 'package:wecheck/flutter_chart/line_chart/monotonex.dart';
...
class LinePainter {
  ...
  static void _drawSolidLine(Canvas canvas, Paint paint, List<Point> points) {
    ...
    //     var value2 = points[i];
    //     var value1 = points[i - 1];
    //     path.quadraticBezierTo(value1.x.toDouble(), value1.y.toDouble(),
    //         value2.x.toDouble(), value2.y.toDouble());
    //   } else if (i == 0) {
    //     var point = points[i];
    //     var point2 = points[i+1];
    //     path.quadraticBezierTo(point.x.toDouble(), point.y.toDouble(), point2.x.toDouble(), point2.y.toDouble());
    //   } else {
    //     var value2 = points[i];
    //     var value1 = points[i - 1];
    //     path.quadraticBezierTo(value1.x.toDouble(), value1.y.toDouble()-50,
    //         value2.x.toDouble(), value2.y.toDouble()-50);
    //   }
    // }
