...
import 'package:wecheck/flutter_chart/common/common.dart';
...
class SmoothLineChart extends StatelessWidget {
  ...
  SmoothLineChart(this.seriesList, {required this.animate});
  ...
  factory SmoothLineChart.withRandomData() {
    return new SmoothLineChart(_createRandomData(), animate: true,);
  }
